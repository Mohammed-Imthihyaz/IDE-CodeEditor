...
import { ChevronDownIcon, Moon, Palette, Sun } from "lucide-react";
...
const ThemeSelector = () => {
  ...
  const { theme, setTheme } = UseCodeEditor();
  const dropdownRef = useRef(null);
  const currentTheme = THEMES.find((t) => t.id === theme);
  //to automatically close the dropdoun when cliked out side of the box
  useEffect(() => {
